...
inline uint8_t get_bit(const std::vector<uint8_t>& sieve, uint64_t i)
{
...
void wheel_factorization_working(const std::vector<uint64_t>& v, mpz_class& t, const mpz_class& primorial, const mpz_class& offset, const std::vector<uint64_t>& primes, const std::vector<uint64_t>& inverses, uint64_t prime_table_limit)
{
    int primes_count = 0;
...
void wheel_factorization(const std::vector<uint64_t>& v, mpz_class& t, const mpz_class& primorial, const mpz_class& offset, const std::vector<uint64_t>& primes, const std::vector<uint64_t>& inverses, uint64_t prime_table_limit)
{
    ...
    std::vector<uint8_t> sieve = get_eliminated_factors(primes, inverses, t_prime, offset, v, prime_table_limit);
...
{                        
    ...
    std::string t_str = tools::get_difficulty_seed(d);
