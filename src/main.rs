...
fn efficient_wheel_factorization_bitvector(v: &Vec<u64>, t: &Integer, primorial: &Integer, offset: &Integer, primes: &Vec<u64>, inverses: &Vec<u64>, prime_table_limit: u64) -> Vec<Integer>
{
    ...
    let sieve = get_eliminated_factors_bitvec(primes, inverses, &t_prime, offset, v, prime_table_limit);
...
fn get_eliminated_factors_bitvec(primes: &Vec<u64>, inverses: &Vec<u64>, t_prime: &Integer, offset: &Integer, v: &Vec<u64>, prime_table_limit: u64) -> BitVec
{
    let k_max = 1000;
